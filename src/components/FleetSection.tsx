          ...
          <Reveal direction="right" className="md:w-1/2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 bg-surface-container-high rounded-lg">
                <span className="text-xs font-bold uppercase tracking-widest opacity-60">Model Years</span>
                <p className="text-xl font-black text-primary dark:text-white">2025–2026</p>
              </div>
              <div className="p-4 bg-surface-container-high rounded-lg">
                <span className="text-xs font-bold uppercase tracking-widest opacity-60">Fleet Condition</span>
